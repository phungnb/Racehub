...
const VERSION = 'rh-v5'   // tăng khi đổi icon / trang offline để máy người dùng lấy bản mới
const STATIC = `${VERSION}-static`
const OFFLINE_URL = '/offline.html'
const PRECACHE = [OFFLINE_URL, '/icons/rh4-icon-192.png', '/icons/rh4-badge-96.png']
