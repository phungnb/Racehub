  ...
  return (
    <div className="bg-surface border border-border rounded-2xl p-4 space-y-3 shadow-xl">
      <div className="flex justify-between items-center">
        ...
        <button className="text-[10px] bg-brand/20 text-brand px-2 py-1 rounded-lg font-bold cursor-pointer">
          + Tạo sự kiện
        </button>
      </div>
      ...
      <div className="space-y-2">
        <div className="bg-bg p-3.5 rounded-xl border border-border space-y-2">
          ...
          <p className="text-[10px] text-fg-muted">Hoàn thành cự ly 5km trong tuần này để tích lũy quỹ thưởng chung cho đồng đội.</p>
