...
export default function CreateChallengeWizard({ isOpen, onClose, onCreated, profile }: CreateChallengeWizardProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-fadeIn">
      <div className="bg-surface border border-border w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden text-white">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto text-xs">
          ...
          <div className="grid grid-cols-2 gap-3 bg-surface-2 p-3 rounded-2xl border border-[#3a3b3c]">
            <div>
              ...
              <select 
                ...
                className="w-full bg-surface border border-[#3a3b3c] rounded-xl px-2.5 py-2 text-xs text-white focus:outline-none focus:border-amber-500"
              >
              ...
              <button
                ...
                className={`py-3 px-4 rounded-2xl border text-xs font-bold transition-all cursor-pointer ${
                  challengeType === 'INDIVIDUAL' 
                    ...
                    : 'bg-surface-2 border-[#3a3b3c] text-gray-400 hover:text-white'
                }`}
              >
                Cá Nhân (Individual)
              </button>
            ...
            <div className="bg-amber-500/5 border border-amber-500/20 p-3 rounded-2xl space-y-3 animate-fadeIn">
              <div>
                ...
                <select 
                  ...
                  className="w-full bg-surface border border-[#3a3b3c] rounded-xl px-3 py-2 text-xs text-white focus:outline-none focus:border-amber-500 font-bold"
                >
          ...
          <div>
            ...
            <input 
              ...
              className="w-full bg-surface-2 border border-[#3a3b3c] rounded-xl px-3 py-2.5 text-xs text-white focus:outline-none focus:border-amber-500"
            />
          </div>
          ...
          <div className="flex items-center justify-between pt-3 border-t border-border">
            ...
            <button 
              ...
              className={`px-5 py-2.5 rounded-xl text-xs font-bold shadow-md transition-all cursor-pointer ${
                hasEnoughXu 
                  ? 'bg-gradient-to-r from-amber-500 to-brand-strong text-white hover:opacity-95' 
