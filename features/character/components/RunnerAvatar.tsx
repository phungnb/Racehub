 ...
 * primitive geometry — không cần model .glb từ họa sĩ 3D nên chạy được ngay.
 * Lấy cảm hứng từ avatar gamified của UpRace: màu rực theo rarity, khối tròn bo.
 */
export default function RunnerAvatar({ avatar, equipment }: RunnerAvatarProps) {
