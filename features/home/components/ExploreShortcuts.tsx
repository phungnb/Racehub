...
import { Gift, Medal, Store, Swords, type LucideIcon } from 'lucide-react'
...
/** Lối tắt trang chủ tới các khu ít nằm trên thanh điều hướng: giải chạy ảo, thách đấu CLB, Chợ Runner, mời bạn */
export function ExploreShortcuts() {
  return (
    <nav aria-label="Khám phá" className="grid grid-cols-4 gap-2">
      {ITEMS.map((x) => (
