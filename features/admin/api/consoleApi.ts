...
export interface AdminInbox { orders: number; reviews: number; partners: number; cups: number; errors: number; reports?: number; new_users_7d: number; active_7d: number; banned: number }
...
export const AUDIT_LABEL: Record<string, string> = {
  USER_BAN: 'Khóa tài khoản', USER_REPORT_DISMISS: 'Bỏ qua báo cáo', USER_REPORT_SUSPEND: 'Khóa Quanh đây', USER_UNBAN: 'Mở khóa tài khoản', USER_ROLE: 'Đổi quyền admin', CHALLENGE_CANCEL: 'Hủy thử thách',
