...
export default function ProfileHeader({ profile, clubName }: { profile: ProfileData, clubName?: string }) {
  ...
  return (
    <div className="space-y-4">
      <div className="bg-gradient-to-br from-slate-900 via-slate-900 to-orange-950/40 border border-orange-500/30 rounded-2xl p-5 shadow-xl flex items-center space-x-4">
        <div className="w-16 h-16 bg-slate-950 rounded-2xl border border-orange-500/40 flex items-center justify-center text-3xl shadow-inner">
          🏃‍♂️
        </div>
