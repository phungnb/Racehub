...
| ◐ SS-04 | **Cửa hàng** (MH19) + **Tủ đồ** (MH26): ✅ nhân vật 2D từ ảnh thật, đổi màu áo/quần/tất/giày giữ nếp vải, Nam/Nữ, 35 bộ màu, thử trước khi mua, quà lên cấp (migration 000900 + 001000, ADR-017). Có trang Quản trị → Vật phẩm (tải lớp PNG, xem thử, ẩn/bán; migration 001200), công cụ tách lớp từ ảnh AI + bộ prompt (`docs/vat-pham/`). Còn: vẽ các món lớp đầu tiên (mũ, kính, áo CLB), vật phẩm theo mùa |
